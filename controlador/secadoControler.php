<?php
    if (isset($_GET['formato'])) {
        ...
        $resultado = mysqli_query($conexion, "SELECT COUNT(*) AS total FROM secado WHERE formato = '$formato'");
        ...
        if ($datosExisten) {
            ...
            header("location: ../secadoRead.php?formato=$formato");
            exit;
        } else {
            // Si no existen datos, incluye el formulario de ingreso de datos
            header("location: ../secado.php?formato=$formato");
            exit;
        }
    } else {
